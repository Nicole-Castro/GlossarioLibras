            ...
            <div class="flex h-16 items-center justify-between">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <img class="h-8 w-8" src="https://www.gov.br/mdh/pt-br/ondh/centrais-de-conteudo/imagens/libras.png" alt="Your Company">
                    </div>
...
<!-- This is an example component -->
     <div class="pt-2 relative text-gray-600">
        <input class="border-2 border-gray-300 bg-slate-50 h-10 px-5 pr-16 rounded-lg text-sm focus:outline-none"
          type="search" name="search" placeholder="Procurar">
